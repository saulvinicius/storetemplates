    	...
    	<div className="header-middle container container-padding">
	        <div className="row">
	        	...
	        	<div className="col-9 col-sm-4 col-header center-logo">
	            	<Link href="/">
	                	<a title="Tri-Jóia" className="link-logo"><img src="https://db7qxt7xxlq5m.cloudfront.net/fit-in/0x0/filters:fill(ffffff)/filters:quality(80)/n49shopv2_trijoia/images/setting/logotipo-trijoia.png" alt="Tri-Jóia" className="header-logo" /></a>
	                </Link>
	        	</div>

	        	<div className="col-3 col-sm-4 col-header">
			...
			<div className="hidden-xs hidden-sm">
				<ul className="container main-menu">
					<li className="menu-item first ">
						<Link href="/produtos/oculos-de-sol">
							<a className="">Óculos de Sol</a>
						</Link>
					</li>								
				</ul>
			</div>
